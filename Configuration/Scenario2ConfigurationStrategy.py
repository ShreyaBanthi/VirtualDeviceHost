...
from VirtualValues.ParsingStrategies.JsonStringMatchParsingStrategy import JsonStringMatchParsingStrategy
...
class Scenario2ConfigurationFactory(ConfigurationStrategy):
    ...
    def create_virtual_devices(self):
        ...
        #                                                   JsonStringMatchParsingStrategy('newState', 'closed', True)))
        #        vv1.add_input_data_source(InputDataSource('DoorSensor2', 'input', "jarvis/door/2/changes", 0,
        #                                                 JsonStringMatchParsingStrategy('newState', 'closed', True)))
        #      vv1.add_input_data_source(InputDataSource('DoorSensor3', 'input', "jarvis/door/3/changes", 0,
        #                                               JsonStringMatchParsingStrategy('newState', 'closed', True)))
